...
void Interface::paint()
{
    ...
    glLoadIdentity();
    //gluLookAt(0.0 + m_fTX + m_fRX, 24.0 + m_fTY + m_fRY, 40.0 + m_fTZ + m_fRZ,  // position de la cam�ra
    //    0.0 + m_fTX, 24.0 + m_fTY, 0.0 + m_fTZ,  // point vers lequel la cam�ra regarde
    //    0.0, 1.0, 0.0);  // vecteur "up"

    gluLookAt(0.0 + m_fTX + m_fRX, 100.0 + m_fTY + m_fRY, 0.0 + m_fTZ + m_fRZ,  // position de la cam�ra
        50.0 + m_fTX, 0.0 + m_fTY, 50.0 + m_fTZ,  // point vers lequel la cam�ra regarde
        0.0, 1.0, 0.0);  // vecteur "up"
